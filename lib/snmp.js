...
function drawNetworkTopology() {
    ...
    var disablePortColor = 0xFFFF00;
    var enablePortColor = 0x00ff00;

    var disableLineColor = 0xFFFF00;
    var enableLineColor = 0x00ff00;
            ...
            this.createSwitch = function (swName, portCount, text) {
                ...
                for (var row = 0; row < 3; row++) {
                    for (var i = 0; i < count; i++) {
                        ...
                        if (row == 0) {
                            var port = this.createPort(name, disablePortColor, portSize, portSize, "top", "tmp", portCount);
                            port.x = (dis * i)-port.width/2;
                            container.addChild(port);
                            index++;
                        } else if (row == 2) {
                            var port = this.createPort(name, disablePortColor, portSize, portSize, "bottom", "tmp", portCount);
